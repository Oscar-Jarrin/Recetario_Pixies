...
You are assisting in the development of an Android application. You must strictly adhere to the following guidelines, architectural patterns, and principles. 
...
* **Responsibilities:** Contains the core business logic. This layer must be independent of any other layer (no Android framework dependencies).
