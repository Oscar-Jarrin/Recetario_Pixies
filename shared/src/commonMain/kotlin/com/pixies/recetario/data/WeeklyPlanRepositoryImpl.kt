...
class WeeklyPlanRepositoryImpl(
    ...
    override suspend fun getPlanByName(name: String): WeeklyPlan {
        val entity = planDao.getPlanByName(name) ?: throw PlanNotFoundException(name)
        return entity.toDomain(assembleSlots(entity.id))
    }
